...
const Publish = () => {
  ...
  const handleSubmit = (e) => {
    if (!submitted) {
      ...
      axios
        .post("http://localhost:3002/property", {
  ...
  return (
    <>
      <h1 className="headline self-center text-[46px] font-[700] not-italic mt-28">
        Publish Your Property
      </h1>
      <form
        onSubmit={handleSubmit}
        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-4 mt-7 place-items-center"
      >
        <input
          type="text"
        ...
        >
          {" "}
          {imageData ? `Uploaded ${imageName}` : "Upload Image"}{" "}
          <span className="text-xl text-gray-600 rounded-lg">
        ...
        <button
          type="submit"
          className="text-white rounded-2xl w-80 h-14 bg-[#205BF1] button-signin col-span-full place-self-center"
        >
          Publish Property
        </button>
      </form>
