    ...
    <>
      <main className="h-screen bg-sign">
        <section className="bg-gradient h-screen w-screen flex flex-col justify-center align-center">
          <h1 className="headline self-center text-[46px] font-[700] not-italic mt-10">
            UniHome: Sign In
          </h1>
          <div className="flex flex-col self-center mt-5">
            ...
            >
              <label htmlFor="username">
                {isUserIconVisible && (
                  <BiUserCircle className="absolute left-2 top-9 text-2xl align-center" />
                )}
              </label>
              <input
                type="text"
              ...
              <button
                type="submit"
                className="text-white rounded-2xl w-80 h-14 bg-[#205BF1] button-signin"
              >
                Sign In
              </button>
            </form>
          </div>
          <p className="mt-5 text-center text-white opacity-50">
