...
const propertyList = [
  ...
  },
  {
    ...
    user: "admin",
    imageUrl:
      'https://i.ibb.co/JcHndgb/448262314-O-1696041109099.jpg" alt="448262314-O-1696041109099',
    imageAlt: "Rear view of modern home with pool",
    location: "Shivjot",
    title: "Modern home in city center in the heart of historic Los Angeles",
    type: "Flat",
...

  {
    ...
    user: "admin",
    imageUrl:
      'https://i.ibb.co/QDNy45p/449999468-O-1696846975857.jpg" alt="449999468-O-1696846975857',
    imageAlt: "Rear view of modern home with pool",
    location: "Omega City",
    title: "Modern home in city center in the heart of historic Los Angeles",
    type: "Flat",
  ...
  },
  {
    ...
    user: "admin",
    imageUrl:
      'https://i.ibb.co/ydVTz7k/452305856-O-1697876155598.jpg" alt="452305856-O-1697876155598',
    imageAlt: "Rear view of modern home with pool",
  ...
  },
  {
    ...
    user: "admin",
    imageUrl:
      'https://i.ibb.co/sy8HN50/453330572-O-1698405964290.jpg" alt="453330572-O-1698405964290',
    imageAlt: "Rear view of modern home with pool",
    location: "GBP Crest",
    title: "Modern home in city center in the heart of historic Los Angeles",
    type: "PG",
...
const corsOptions = {
  origin: [
    "http://localhost:3000",
    "http://localhost:8000",
    "https://flat-apartment-rent.vercel.app",
  ],
};

// Define a username and password for authentication
const username = "OmVerma";
